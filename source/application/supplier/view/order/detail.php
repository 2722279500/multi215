            ...
            <div class="widget am-cf">
                <div class="widget__order-detail widget-body am-margin-bottom-lg">
                                ...
                                <td class="">
                                    <div class="td__order-price am-text-left">
                                        ...
                                        <ul class="am-avg-sm-2">
                                            ...
                                            <li class="am-text-right">+￥<?= $detail['express_price'] ?><span style="font-weight: 700;color: #f60;">&nbsp;(￥<?= citrixGetSupplierExpressPrice($detail['order_id'],$_supplier_user['supplier_user_id']) ?>)</span></li>
                                        </ul>
                                        ...
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][0] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][1] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][2] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][3] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][4] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][5] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][6] ?></p>
                                        <p style="text-align: left;"><?= $detail['gross_profit']['describe'][7] ?></p>
                                    </div>
                                </td>
                                <td>
                        ...
                        <table class="regional-table am-table am-table-bordered am-table-centered
                            ...
                            <tr>
                                <td colspan="7" class="am-text-right am-cf">
                                    ...
                                    <span class="am-fr"><!-- 总计金额： ￥--><?= $detail['gross_profit']['describe'][1] ?></span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <?php if (
                        ...
                        <?php if ($detail['delivery_status']['value'] == 10 || $detail['delivery_status']['value'] == 30): ?>
