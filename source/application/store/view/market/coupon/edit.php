                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group" data-x-switch>
                                ...
                                <div class="am-u-sm-9 am-u-end citrix-cates-limit">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[limitgoodcatetype]" value="0" class="citrix-radio" <?= $model['limitgoodcatetype'] == 0 ? 'checked' : '' ?> >
                                        不添加商品分类限制
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[limitgoodcatetype]" value="1" class="citrix-radio" <?= $model['limitgoodcatetype'] == 1 ? 'checked' : '' ?>>
                                        允许以下商品分类使用
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group citrix-cates-item" data-x-switch>
                                <?php if ($model['limitgoodcatetype']): ?>
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">选择商品分类 </label>
                                <div class="am-u-sm-9 am-u-end citrix-select">
                                    <ul class="citrix-choices-ul">
                                        <?php if (!empty($model['category_'])): foreach ($model['category_'] as $ck1 => $cv1):?>
                                            <li class="citrix-choice citrix-choice-del-<?= $cv1['id'] ?>" data-id="<?= $cv1['id'] ?>" data-val="<?= $cv1['name'] ?>">
                                                <i class="iconfont icon-shibai citrix-choice-item-del" data-id="<?= $cv1['id'] ?>">&nbsp;</i>
                                                <input type="text" name="coupon[category][<?= $cv1['id'] ?>]" readonly="" value="<?= $cv1['name'] ?>" class="citrix-category" style="background: #ddd!important;">
                                            </li>
                            ...
                            <div class="am-form-group" data-x-switch>
                                ...
                                <div class="am-u-sm-9 am-u-end citrix-goods-limit">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[limitgoodtype]" value="0" class="citrix-radio" <?= $model['limitgoodtype'] == 0 ? 'checked' : '' ?> >
                                        不添加商品限制
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[limitgoodtype]" value="1" class="citrix-radio" <?= $model['limitgoodtype'] == 1 ? 'checked' : '' ?>>
                                        允许以下商品使用
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group citrix-goods-item" data-x-switch>
                                <?php if ($model['limitgoodtype']): ?>
                                ...
                                <div class="am-u-sm-9 am-u-end citrix-goods-list">
                                    ...
                                    <?php if (!empty($model['goods_'])): foreach ($model['goods_'] as $gk1 => $gv1):?>
                                    <dl class="citrix-goods-dl citrix-goods-item-<?= $gv1['id'] ?>" data-id="<?= $gv1['id'] ?>">
                                            <i class="iconfont icon-shibai citrix-goods-del" data-id="<?= $gv1['id'] ?>">&nbsp;</i>
                                            <dt>
                                                <img src="<?= $gv1['image'] ?>" width="180" height="180">
                                            </dt>
                                            <input type="hidden" name="coupon[goods][<?= $gv1['id'] ?>]" value="<?= $gv1['id'] ?>">
                                            <input type="hidden" name="coupon[goods_image][<?= $gv1['id'] ?>]" value="<?= $gv1['image'] ?>">
                                            <input type="hidden" name="coupon[goods_name][<?= $gv1['id'] ?>]" value="<?= $gv1['name'] ?>">
                                            <dd><?= $gv1['name'] ?></dd>
                                    </dl>
                                    <?php endforeach; endif; ?>
                                </div>
