                    ...
                    <div class="navs">
                        <div class="navs-group">
                            ...
                            <div class="navs-components am-cf">
                                ...
                                <nav class="special" @click="onAddItem('navigate')">
                                    ...
                                    <div @click.stop="onEditer(index)"
                                        ...
                                        <div class="diy-guide"
                                            ...
                                            <div class="diy-navigate">
                                                <div class="diy-navigate-text"><img :src="item.params.image" width="26px" alt=""><span style="margin-left:4px;">{{ item.params.name }}</span></div><i class='iconfont icon-xiangyoujiantou'></i>
                                            </div>
                                        </div>
                                        <div class="btn-edit-del">
                                            <div class="btn-del" @click.stop="onDeleleItem(index)">删除</div>
                    ...
                    <template v-if="diyData.items.length && curItem">
                        ...
                        <div id="tpl_editor_guide" v-if="curItem.type == 'navigate'">
                            ...
                            <form class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-form-label am-text-xs">提示文字 </label>
                                    <div class="am-u-sm-8 am-u-end">
                                        <input class="tpl-form-input" type="text"
                                               v-model="curItem.params.name">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-form-label am-text-xs">跳转链接 </label>
                                    <div class="am-u-sm-8 am-u-end">
                                        <input class="tpl-form-input" type="text"
                                               v-model="curItem.params.navigateUrl">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-form-label am-text-xs">上下边距 </label>
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-4 am-form-label am-text-xs"> 导航图标 </label>
                                    <div class="am-u-sm-8 am-u-end">
                                        <div class="data-image">
                                            <img :src="curItem.params.image"
                                                 style="height: 45px;" title="点击更换图片" alt=""
