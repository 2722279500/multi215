...
class Category extends BaseModel
{
    ...
    {
        $model = new static;
        if (!Cache::get('merchant_category_' . $model::$wxapp_id)) {
            ...
            Cache::tag('cache')->set('merchant_category_' . $model::$wxapp_id, compact('all', 'tree'));
        }
        return Cache::get('merchant_category_' . $model::$wxapp_id);
    }
