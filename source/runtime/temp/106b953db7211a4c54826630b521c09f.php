<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"E:\phpstudy_pro\WWW\shop215555\shop215\web/../source/application/supplier\view\passport\login.php";i:1591953723;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="login-content">
            ...
            <form id="login-form" class="login-form">
                <div class="form-group">
                    <input class="" name="User[username]" placeholder="请输入用户名" type="text" required>
                </div>
                <div class="form-group">
