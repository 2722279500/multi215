<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:105:"E:\phpstudy_pro\WWW\shop215555\shop215\web/../source/application/store\view\apps\merchant\active\edit.php";i:1592468533;s:87:"E:\phpstudy_pro\WWW\shop215555\shop215\source\application\store\view\layouts\layout.php";i:1591840256;s:104:"E:\phpstudy_pro\WWW\shop215555\shop215\source\application\store\view\layouts\_template\tpl_file_item.php";i:1591840256;s:103:"E:\phpstudy_pro\WWW\shop215555\shop215\source\application\store\view\layouts\_template\file_library.php";i:1591840256;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    ...
                                    <div class="am-input-group">
                                        <input type="text" class="j-laydate-start am-form-field"
                                               ...
                                               placeholder="开始时间" value="<?= date("Y-m-d H:i:s",$model['start_time']) ?>">
                                        ...
                                        <input type="text" class="j-laydate-end am-form-field"
                                               ...
                                               placeholder="结束时间" value="<?= date("Y-m-d H:i:s",$model['end_time']) ?>">
                                    </div>
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        <input type="text" class="tpl-form-input"
                                               ...
                                               placeholder="抽成比例" id="citrixSupplierRebate" value="<?= $model['supplier_rebate'] ?>">
                                    </div>
                                    <div class="help-block">
                                        <small>0-100之间</small>
                                    </div>
