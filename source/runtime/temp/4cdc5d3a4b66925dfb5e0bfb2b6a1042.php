<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:108:"E:\phpstudy_pro\WWW\shop215555\shop215\web/../source/application/store\view\apps\merchant\category\index.php";i:1591869471;s:87:"E:\phpstudy_pro\WWW\shop215555\shop215\source\application\store\view\layouts\layout.php";i:1591840256;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">商家分类</div>
                </div>
                                ...
                                <?php if (checkPrivilege('apps.merchant.category/add')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-success am-radius"
                                           href="<?= url('apps.merchant.category/add') ?>">
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('apps.merchant.category/edit')): ?>
                                                <a href="<?= url('apps.merchant.category/edit',
                                                    ['category_id' => $first['category_id']]) ?>">
                                                    <i class="am-icon-pencil"></i> 编辑
                                                </a>
                                            <?php endif; if (checkPrivilege('apps.merchant.category/delete')): ?>
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('apps.merchant.category/delete') ?>";
